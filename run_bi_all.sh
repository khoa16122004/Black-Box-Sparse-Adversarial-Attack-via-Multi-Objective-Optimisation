#!/bin/bash
#SBATCH --job-name=bi_attack_eps=100
...
python run_all_batch.py \
    ...
    --output_dir output_bi_eps=30/resnet18_inter \
    --model_name resnet18 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    --runned_data_path model_evaluation_results/resnet18_selection.json \
    --output_dir output_bi_eps=30/resnet18_simple \
    --model_name resnet18 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    ...
    --output_dir output_bi_eps=30/vgg16_inter \
    --model_name vgg16 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    --runned_data_path model_evaluation_results/vgg16_selection.json \
    --output_dir output_bi_eps=30/vgg16_simple \
    --model_name vgg16 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    ...
    --output_dir output_bi_eps=30/densenet121_inter \
...
python run_all_batch.py \
    --runned_data_path model_evaluation_results/densenet121_selection.json \
    --output_dir output_bi_eps=30/densenet121_simple \
    --model_name densenet121 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    ...
    --output_dir output_bi_eps=30/vit_b_32_inter \
    --model_name vit_b_32 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
...
python run_all_batch.py \
    --runned_data_path model_evaluation_results/vit_b_32_selection.json \
    --output_dir output_bi_eps=30/vit_b_32_simple \
    --model_name vit_b_32 \
    --eps 30 \
    --iterations 200 \
    --pc 0.1 \
